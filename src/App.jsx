...
export default function App() {
  ...
  function handleFindRoute() {
    ...
    setRoute({
      ...
      path: result.path,
      steps: formatRoute(result.edges, airport.nodeMap),
    });
  }
    ...
    <AppShell>
      ...
      {airportCode && airport?.status !== 'mapped' && (
        <section className="guide-card coming-soon-card">
          <h2>Basic Guide Mode Coming Soon</h2>
          <p>{airport?.name || airportCode} is listed, but detailed indoor routing is not available yet.</p>
          <p>
            This MVP will not create a fake route. Please check official airport maps, posted signage,
